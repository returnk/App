<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:85:"/data/home/byu3109350001/htdocs/app/public/../application/admin/view/version/add.html";i:1535966879;s:86:"/data/home/byu3109350001/htdocs/app/public/../application/admin/view/public/_meta.html";i:1535958875;s:88:"/data/home/byu3109350001/htdocs/app/public/../application/admin/view/public/_footer.html";i:1535954704;}*/ ?>
<!--header-->
<!DOCTYPE HTML>
<html>
<head>
...
<article class="page-container">
    <form class="form form-horizontal" id="form-singwaapp" url="<?php echo url('version/add'); ?>" method="post">
        <div class="row cl">
        ...
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>手机类型：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="" placeholder="" id="app_type" name="app_type">
            </div>
        </div>
        ...
        <div class="row cl">
     <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>升级提示：</label>
      <div class="formControls col-xs-8 col-sm-9">
        <textarea name="upgrade_point" cols="" rows="" class="textarea"  placeholder="说点什么...最少输入10个字符" datatype="*10-100" dragonfly="true" nullmsg="备注不能为空！" id="upgrade_point"></textarea>
                    ...
                    $(function(){
                        ...
                        $("#form-singwaapp").validate({
                            ...
                            submitHandler:function(form){
                                $ajax.post();// 需要小伙伴自定义一个singwaapp_save方法 用来处理抛送请求的哦
                            }
                        });
